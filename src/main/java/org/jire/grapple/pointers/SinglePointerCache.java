...
final class SinglePointerCache extends AbstractPointerCache {
	
	private final Pointer pointer = Pointer.createConstant(Pointers.NULL);
	
	@Override
	public Pointer forPeer(long peer) {
		Pointer.nativeValue(pointer, peer);
		return pointer;
	}
